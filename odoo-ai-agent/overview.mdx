...
<CardGroup cols={2}>
  ...
  <Card title="6. Blueprint connector AI" href="/odoo-ai-agent/connector-blueprint" icon="cpu">
    Thiết kế sản phẩm: connector đa-provider LLM (provider, engine, audit, fallback, IAP) đa phiên bản.
  </Card>
</CardGroup>
